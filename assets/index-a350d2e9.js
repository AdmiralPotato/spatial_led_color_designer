...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Oc(){return new vi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Bc(){return new vi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
...
return [
  ...
  brightness,
  brightness
]`.trim()}],Za=Ka("colorFunctionString",St(Zf[0].value)),Lr=Ka("userPresets",St([]));let ys=()=>[1,1,1];const Jf=()=>{const n=Za.value;try{ys=new Function("config",`
			const {
				index,
				count,
				position,
...
`;const DM={class:"TimelineControl"},IM=Ue("span",null,"play",-1),NM=Ue("span",{title:"The beginning of all time"},"start",-1),FM=Ue("span",{title:"The end of the world"},"end",-1),OM=Ue("span",{title:"The frame which is currently displayed"},"frame",-1),BM=Ue("span",{title:"Frames Per Second"},"fps",-1),zM={class:"timeline"},HM=["onMousedown","onMousemove"],GM={class:"hover"},VM={__name:"TimelineControl",setup(n){const{isPlaying:e,startFrame:t,endFrame:i,currentFrame:r,framesPerSecond:s}=to(),a=Ha(()=>i.value-t.value+7),o=St(!1),l=f=>{r.value=f},c=f=>{o.value&&l(f)},u=()=>{o.value=!1};return document.body.addEventListener("mouseup",u),ju(()=>{document.body.removeEventListener("mouseup",u)}),(f,d)=>(Ot(),jt("div",DM,[Ue("form",{onSubmit:d[5]||(d[5]=Ls(()=>{},["prevent"]))},[Ue("div",null,[Ue("label",null,[IM,ii(Ue("input",{type:"checkbox","onUpdate:modelValue":d[0]||(d[0]=m=>nt(e)?e.value=m:null)},null,512),[[Cp,Ke(e)]])]),Ue("label",null,[NM,ii(Ue("input",{type:"number","onUpdate:modelValue":d[1]||(d[1]=m=>nt(t)?t.value=m:null)},null,512),[[Hi,Ke(t)]])]),Ue("label",null,[FM,ii(Ue("input",{type:"number","onUpdate:modelValue":d[2]||(d[2]=m=>nt(i)?i.value=m:null)},null,512),[[Hi,Ke(i)]])]),Ue("label",null,[OM,ii(Ue("input",{type:"number","onUpdate:modelValue":d[3]||(d[3]=m=>nt(r)?r.value=m:null)},null,512),[[Hi,Ke(r)]])]),Ue("label",null,[BM,ii(Ue("input",{type:"number","onUpdate:modelValue":d[4]||(d[4]=m=>nt(s)?s.value=m:null)},null,512),[[Hi,Ke(s)]])])])],32),Ue("div",zM,[Ue("div",{class:"bars",onMousedown:d[6]||(d[6]=m=>o.value=!0),onMouseup:d[7]||(d[7]=m=>o.value=!1)},[(Ot(!0),jt(Ht,null,ea(a.value,(m,x)=>(Ot(),jt("span",{class:Ir(["bar",{darker:x-2>Ke(i)||x-2<Ke(t),active:x-2===Ke(r)}]),key:x,style:Dr({width:100/a.value+"%"}),onMousedown:v=>l(x-2),onMousemove:v=>c(x-2)},[Ue("span",GM,yr(x-2),1)],46,HM))),128))],32)])]))}},kM=Ue("span",null,"Vertex Color Function",-1),WM=["onClick"],XM=Ue("input",{type:"submit",value:"Process Color Function"},null,-1),qM={key:0},YM=Ue("h3",null,"User patterns (localStorage)",-1),jM=["onClick"],$M=["onClick","title"],KM={__name:"ColorFunctionControl",setup(n){const{presets:e,userPresets:t,colorFunctionString:i,removePresetByName:r,saveCurrentPattern:s,processColorFunction:a}=Qf();return(o,l)=>(Ot(),jt("form",{id:"equations",onSubmit:l[2]||(l[2]=Ls((...c)=>Ke(a)&&Ke(a)(...c),["prevent"]))},[Ue("div",null,[Ue("label",null,[kM,ii(Ue("textarea",{"onUpdate:modelValue":l[0]||(l[0]=c=>nt(i)?i.value=c:null),rows:"7",cols:"80"},null,512),[[Hi,Ke(i)]])])]),Ue("div",null,[(Ot(!0),jt(Ht,null,ea(Ke(e),c=>(Ot(),jt("button",{class:"preset-button",key:c.label,type:"button",onClick:u=>{i.value=c.value,Ke(a)()}},yr(c.label),9,WM))),128)),Ue("button",{class:"save",type:"button",onClick:l[1]||(l[1]=(...c)=>Ke(s)&&Ke(s)(...c))}," Save current pattern "),XM]),Ke(t).length?(Ot(),jt("div",qM,[YM,Ue("div",null,[(Ot(!0),jt(Ht,null,ea(Ke(t),c=>(Ot(),jt("span",{key:c.label},[Ue("button",{class:"preset-button",type:"button",onClick:u=>{i.value=c.value,Ke(a)()}},yr(c.label),9,jM),Ue("button",{class:"delete-button",type:"button",onClick:u=>Ke(r)(c.label),title:"Delete the pattern: "+c.label}," x ",8,$M)]))),128))])])):oa("",!0)],32))}},{processOutputColors:ZM}=rh(),{startFrame:JM,endFrame:QM,framesPerSecond:eE}=to(),hu=St(null),va=St(""),du=(n,e)=>{let[...t]=n;for(var i=[];t.length;)i.push(t.splice(0,e));return i},tE=n=>{const e=va.value.replaceAll(" ","_"),t=e.toLocaleUpperCase(),i=n.map(c=>"0x"+c.toString(16).padStart(2,"0").toLocaleUpperCase()),r=QM.value-JM.value+1,s=n.length/3/r,a=r*s-1,o=du(i,3).map((c,u)=>{let f=",";return u===a&&(f=""),`	${c.join(", ")}${f} // ${u%s}`}),l=du(o,s).map((c,u)=>`	// frame index ${u}
${c.join(`
`)}`);return`#ifndef ${t}_H
#define ${t}_H
...
static const uint32_t ${e}_frame_rate = ${eE.value};
...
#endif /* ${t}_H */
`},nE=(n,e)=>{let t=n,i="octet/stream";typeof t=="string"&&(t=[t],i="text/plain");const r=new Blob(t,{type:i});return{href:window.URL.createObjectURL(r),target:"_blank",download:e}},iE=()=>({outputName:va,processedDownloadLink:hu,processOutput:()=>{const n=ZM(),e=tE(n);console.log("cHeaderText",e),hu.value=nE(e,va.value+".h")}});const rE={id:"controls"},sE=Ue("span",null,"Output object name (probably use snake case or camel case)",-1),oE=Ue("div",null,[Ue("input",{type:"submit",value:"Process Output"})],-1),aE={key:0},lE={class:"bottom-panel"},cE={__name:"App",setup(n){const{processObjText:e}=rh(),{advanceFrame:t,previousFrame:i,isPlaying:r}=to(),{outputName:s,processedDownloadLink:a,processOutput:o}=iE(),l=St([]),c=Ka("lastUploadedObjText",St(UM)),u=Ha(()=>l.value.length),f=p=>{c.value=p,l.value=e(p)},d=p=>{p.target.files[0].text().then(f)};f(c.value);const m=St(!1),x={"`":()=>{m.value=!m.value}," ":()=>{r.value=!r.value},ArrowRight:()=>{r.value=!1,t()},ArrowLeft:()=>{r.value=!1,i()}},v=["INPUT","TEXTAREA","SELECT"];return window.addEventListener("keydown",p=>{console.log(`What is key? "${p.key}"`);const h=x[p.key];h&&!v.includes(p.target.tagName)&&(p.preventDefault(),h())}),(p,h)=>(Ot(),jt("div",rE,[Ue("div",null,"vertCount: "+yr(u.value),1),Ue("form",{onSubmit:h[0]||(h[0]=Ls(()=>{},["prevent"]))},[Ue("div",null,[Ue("input",{type:"file",onInput:d},null,32)])],32),Ue("form",{onSubmit:h[2]||(h[2]=Ls((...w)=>Ke(o)&&Ke(o)(...w),["prevent"]))},[Ue("div",null,[Ue("label",null,[sE,ii(Ue("input",{type:"text","onUpdate:modelValue":h[1]||(h[1]=w=>nt(s)?s.value=w:null)},null,512),[[Hi,Ke(s)]])])]),oE],32),Ke(a)?(Ot(),jt("p",aE,[Ue("a",Eh(lf(Ke(a))),[cf("Download "),Ue("code",null,yr(Ke(s))+".h",1)],16)])):oa("",!0),Ue("div",lE,[m.value?(Ot(),of(KM,{key:0})):oa("",!0),un(VM)])]))}};const sh=Np(cE);sh.use(zp());sh.mount("#app");
