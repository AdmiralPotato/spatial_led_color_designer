...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Dc(){return new vi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function Ic(){return new vi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
	...
	`}function $g(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===oa||l===aa,u=l===Ji||l===Qi;if(c||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let f=e.get(o);return t===null&&(t=new Lc(n)),f=c?t.fromEquirectangular(o,f):t.fromCubemap(o,f),e.set(o,f),f.texture}else{if(e.has(o))return e.get(o).texture;{const f=o.image;if(c&&f&&f.height>0||u&&f&&r(f)){t===null&&(t=new Lc(n));const d=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,d),o.addEventListener("dispose",s),d.texture}else return null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function Zg(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(i){i.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(i){const r=t(i);return r===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Jg(n,e,t,i){const r={},s=new WeakMap;function a(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const x in d.attributes)e.remove(d.attributes[x]);for(const x in d.morphAttributes){const v=d.morphAttributes[x];for(let p=0,h=v.length;p<h;p++)e.remove(v[p])}d.removeEventListener("dispose",a),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(f,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const x in d)e.update(d[x],n.ARRAY_BUFFER);const m=f.morphAttributes;for(const x in m){const v=m[x];for(let p=0,h=v.length;p<h;p++)e.update(v[p],n.ARRAY_BUFFER)}}function c(f){const d=[],m=f.index,x=f.attributes.position;let v=0;if(m!==null){const w=m.array;v=m.version;for(let S=0,T=w.length;S<T;S+=3){const A=w[S+0],P=w[S+1],D=w[S+2];d.push(A,P,P,D,D,A)}}else{const w=x.array;v=x.version;for(let S=0,T=w.length/3-1;S<T;S+=3){const A=S+0,P=S+1,D=S+2;d.push(A,P,P,D,D,A)}}const p=new(yf(d)?Pf:Cf)(d,1);p.version=v;const h=s.get(f);h&&e.remove(h),s.set(f,p)}function u(f){const d=s.get(f);if(d){const m=f.index;m!==null&&d.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:u}}function Qg(n,e,t,i){const r=i.isWebGL2;let s;function a(d){s=d}let o,l;function c(d){o=d.type,l=d.bytesPerElement}function u(d,m){n.drawElements(s,m,o,d*l),t.update(m,s,1)}function f(d,m,x){if(x===0)return;let v,p;if(r)v=n,p="drawElementsInstanced";else if(v=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",v===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}v[p](s,m,o,d*l,x),t.update(m,s,x)}this.setMode=a,this.setIndex=c,this.render=u,this.renderInstances=f}function ev(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function tv(n,e){return n[0]-e[0]}function nv(n,e){return Math.abs(e[1])-Math.abs(n[1])}function iv(n,e,t){const i={},r=new Float32Array(8),s=new WeakMap,a=new mt,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,u,f){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const x=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,v=x!==void 0?x.length:0;let p=s.get(u);if(p===void 0||p.count!==v){let K=function(){G.dispose(),s.delete(u),u.removeEventListener("dispose",K)};var m=K;p!==void 0&&p.texture.dispose();const S=u.morphAttributes.position!==void 0,T=u.morphAttributes.normal!==void 0,A=u.morphAttributes.color!==void 0,P=u.morphAttributes.position||[],D=u.morphAttributes.normal||[],N=u.morphAttributes.color||[];let E=0;S===!0&&(E=1),T===!0&&(E=2),A===!0&&(E=3);let R=u.attributes.position.count*E,ie=1;R>e.maxTextureSize&&(ie=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const fe=new Float32Array(R*ie*4*v),G=new Af(fe,R,ie,v);G.type=Nn,G.needsUpdate=!0;const Y=E*4;for(let re=0;re<v;re++){const W=P[re],q=D[re],ce=N[re],ae=R*ie*4*re;for(let ye=0;ye<W.count;ye++){const O=ye*Y;S===!0&&(a.fromBufferAttribute(W,ye),fe[ae+O+0]=a.x,fe[ae+O+1]=a.y,fe[ae+O+2]=a.z,fe[ae+O+3]=0),T===!0&&(a.fromBufferAttribute(q,ye),fe[ae+O+4]=a.x,fe[ae+O+5]=a.y,fe[ae+O+6]=a.z,fe[ae+O+7]=0),A===!0&&(a.fromBufferAttribute(ce,ye),fe[ae+O+8]=a.x,fe[ae+O+9]=a.y,fe[ae+O+10]=a.z,fe[ae+O+11]=ce.itemSize===4?a.w:1)}}p={count:v,texture:G,size:new He(R,ie)},s.set(u,p),u.addEventListener("dispose",K)}let h=0;for(let S=0;S<d.length;S++)h+=d[S];const w=u.morphTargetsRelative?1:1-h;f.getUniforms().setValue(n,"morphTargetBaseInfluence",w),f.getUniforms().setValue(n,"morphTargetInfluences",d),f.getUniforms().setValue(n,"morphTargetsTexture",p.texture,t),f.getUniforms().setValue(n,"morphTargetsTextureSize",p.size)}else{const x=d===void 0?0:d.length;let v=i[u.id];if(v===void 0||v.length!==x){v=[];for(let T=0;T<x;T++)v[T]=[T,0];i[u.id]=v}for(let T=0;T<x;T++){const A=v[T];A[0]=T,A[1]=d[T]}v.sort(nv);for(let T=0;T<8;T++)T<x&&v[T][1]?(o[T][0]=v[T][0],o[T][1]=v[T][1]):(o[T][0]=Number.MAX_SAFE_INTEGER,o[T][1]=0);o.sort(tv);const p=u.morphAttributes.position,h=u.morphAttributes.normal;let w=0;for(let T=0;T<8;T++){const A=o[T],P=A[0],D=A[1];P!==Number.MAX_SAFE_INTEGER&&D?(p&&u.getAttribute("morphTarget"+T)!==p[P]&&u.setAttribute("morphTarget"+T,p[P]),h&&u.getAttribute("morphNormal"+T)!==h[P]&&u.setAttribute("morphNormal"+T,h[P]),r[T]=D,w+=D):(p&&u.hasAttribute("morphTarget"+T)===!0&&u.deleteAttribute("morphTarget"+T),h&&u.hasAttribute("morphNormal"+T)===!0&&u.deleteAttribute("morphNormal"+T),r[T]=0)}const S=u.morphTargetsRelative?1:1-w;f.getUniforms().setValue(n,"morphTargetBaseInfluence",S),f.getUniforms().setValue(n,"morphTargetInfluences",r)}}return{update:l}}function rv(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,f=e.get(l,u);return r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER)),f}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const Ff=new Ot,Of=new Af,Bf=new qm,zf=new Df,Nc=[],Fc=[],Oc=new Float32Array(16),Bc=new Float32Array(9),zc=new Float32Array(4);function sr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=Nc[r];if(s===void 0&&(s=new Float32Array(r),Nc[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function ft(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ht(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Js(n,e){let t=Fc[e];t===void 0&&(t=new Int32Array(e),Fc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function sv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function ov(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ft(t,e))return;n.uniform2fv(this.addr,e),ht(t,e)}}function av(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ft(t,e))return;n.uniform3fv(this.addr,e),ht(t,e)}}function lv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ft(t,e))return;n.uniform4fv(this.addr,e),ht(t,e)}}function cv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ft(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ht(t,e)}else{if(ft(t,i))return;zc.set(i),n.uniformMatrix2fv(this.addr,!1,zc),ht(t,i)}}function uv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ft(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ht(t,e)}else{if(ft(t,i))return;Bc.set(i),n.uniformMatrix3fv(this.addr,!1,Bc),ht(t,i)}}function fv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ft(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ht(t,e)}else{if(ft(t,i))return;Oc.set(i),n.uniformMatrix4fv(this.addr,!1,Oc),ht(t,i)}}function hv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function dv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ft(t,e))return;n.uniform2iv(this.addr,e),ht(t,e)}}function pv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ft(t,e))return;n.uniform3iv(this.addr,e),ht(t,e)}}function mv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ft(t,e))return;n.uniform4iv(this.addr,e),ht(t,e)}}function _v(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function gv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ft(t,e))return;n.uniform2uiv(this.addr,e),ht(t,e)}}function vv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ft(t,e))return;n.uniform3uiv(this.addr,e),ht(t,e)}}function xv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ft(t,e))return;n.uniform4uiv(this.addr,e),ht(t,e)}}function Mv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2D(e||Ff,r)}function Ev(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Bf,r)}function Sv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||zf,r)}function yv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Of,r)}function Tv(n){switch(n){case 5126:return sv;case 35664:return ov;case 35665:return av;case 35666:return lv;case 35674:return cv;case 35675:return uv;case 35676:return fv;case 5124:case 35670:return hv;case 35667:case 35671:return dv;case 35668:case 35672:return pv;case 35669:case 35673:return mv;case 5125:return _v;case 36294:return gv;case 36295:return vv;case 36296:return xv;case 35678:case 36198:case 36298:case 36306:case 35682:return Mv;case 35679:case 36299:case 36307:return Ev;case 35680:case 36300:case 36308:case 36293:return Sv;case 36289:case 36303:case 36311:case 36292:return yv}}function bv(n,e){n.uniform1fv(this.addr,e)}function Av(n,e){const t=sr(e,this.size,2);n.uniform2fv(this.addr,t)}function wv(n,e){const t=sr(e,this.size,3);n.uniform3fv(this.addr,t)}function Rv(n,e){const t=sr(e,this.size,4);n.uniform4fv(this.addr,t)}function Cv(n,e){const t=sr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Pv(n,e){const t=sr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Lv(n,e){const t=sr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Uv(n,e){n.uniform1iv(this.addr,e)}function Dv(n,e){n.uniform2iv(this.addr,e)}function Iv(n,e){n.uniform3iv(this.addr,e)}function Nv(n,e){n.uniform4iv(this.addr,e)}function Fv(n,e){n.uniform1uiv(this.addr,e)}function Ov(n,e){n.uniform2uiv(this.addr,e)}function Bv(n,e){n.uniform3uiv(this.addr,e)}function zv(n,e){n.uniform4uiv(this.addr,e)}function Hv(n,e,t){const i=this.cache,r=e.length,s=Js(t,r);ft(i,s)||(n.uniform1iv(this.addr,s),ht(i,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||Ff,s[a])}function Gv(n,e,t){const i=this.cache,r=e.length,s=Js(t,r);ft(i,s)||(n.uniform1iv(this.addr,s),ht(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Bf,s[a])}function Vv(n,e,t){const i=this.cache,r=e.length,s=Js(t,r);ft(i,s)||(n.uniform1iv(this.addr,s),ht(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||zf,s[a])}function kv(n,e,t){const i=this.cache,r=e.length,s=Js(t,r);ft(i,s)||(n.uniform1iv(this.addr,s),ht(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Of,s[a])}function Wv(n){switch(n){case 5126:return bv;case 35664:return Av;case 35665:return wv;case 35666:return Rv;case 35674:return Cv;case 35675:return Pv;case 35676:return Lv;case 5124:case 35670:return Uv;case 35667:case 35671:return Dv;case 35668:case 35672:return Iv;case 35669:case 35673:return Nv;case 5125:return Fv;case 36294:return Ov;case 36295:return Bv;case 36296:return zv;case 35678:case 36198:case 36298:case 36306:case 35682:return Hv;case 35679:case 36299:case 36307:return Gv;case 35680:case 36300:case 36308:case 36293:return Vv;case 36289:case 36303:case 36311:case 36292:return kv}}class Xv{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.setValue=Tv(t.type)}}class qv{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.size=t.size,this.setValue=Wv(t.type)}}class Yv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const Go=/(\w+)(\])?(\[|\.)?/g;function Hc(n,e){n.seq.push(e),n.map[e.id]=e}function jv(n,e,t){const i=n.name,r=i.length;for(Go.lastIndex=0;;){const s=Go.exec(i),a=Go.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Hc(t,c===void 0?new Xv(o,n,e):new qv(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new Yv(o),Hc(t,f)),t=f}}}class Ms{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);jv(s,a,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function Gc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}let Kv=0;function $v(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}function Zv(n){switch(n){case hn:return["Linear","( value )"];case ze:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),["Linear","( value )"]}}function Vc(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+$v(n.getShaderSource(e),a)}else return r}function Jv(n,e){const t=Zv(e);return"vec4 "+n+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function Qv(n,e){let t;switch(e){case cm:t="Linear";break;case um:t="Reinhard";break;case fm:t="OptimizedCineon";break;case hm:t="ACESFilmic";break;case dm:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function ex(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(pr).join(`
`)}function tx(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function nx(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),a=s.name;let o=1;s.type===n.FLOAT_MAT2&&(o=2),s.type===n.FLOAT_MAT3&&(o=3),s.type===n.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function pr(n){return n!==""}function kc(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Wc(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ix=/^[ \t]*#include +<([\w\d./]+)>/gm;function da(n){return n.replace(ix,rx)}function rx(n,e){const t=Ge[e];if(t===void 0)throw new Error("Can not resolve #include <"+e+">");return da(t)}const sx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Xc(n){return n.replace(sx,ox)}function ox(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function qc(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function ax(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===uf?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Gp?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Mn&&(e="SHADOWMAP_TYPE_VSM"),e}function lx(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ji:case Qi:e="ENVMAP_TYPE_CUBE";break;case js:e="ENVMAP_TYPE_CUBE_UV";break}return e}function cx(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Qi:e="ENVMAP_MODE_REFRACTION";break}return e}function ux(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case df:e="ENVMAP_BLENDING_MULTIPLY";break;case am:e="ENVMAP_BLENDING_MIX";break;case lm:e="ENVMAP_BLENDING_ADD";break}return e}function fx(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function hx(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=ax(t),c=lx(t),u=cx(t),f=ux(t),d=fx(t),m=t.isWebGL2?"":ex(t),x=tx(s),v=r.createProgram();let p,h,w=t.glslVersion?"#version "+t.glslVersion+`
...
return [
  ...
  brightness,
  brightness
]`.trim()}],$f=jf("colorFunctionString",Rt(Kf[0].value));let Es=()=>[1,1,1];const Zf=()=>{const n=$f.value;try{Es=new Function("config",`
			const {
				index,
				count,
				position,
			...
			tau = Math.PI * 2;
			${n}
			`),Es({index:0,count:1,position:{x:0,y:0,z:0},time:0})}catch(e){Es=null,console.error(e)}};Zf();const Jf=()=>({presets:Kf,colorFunctionString:$f,processColorFunction:Zf,getColorFunction(){return Es}}),{endFrame:Qf,startFrame:Ns,currentFrame:EM}=eo(),{getColorFunction:eh}=Jf(),_r=document.getElementById("eyyyyy"),Fs=new Hf({canvas:_r,alpha:!0,antialias:!0}),Gn=new Ht(45,window.innerWidth/window.innerHeight,.1,1e4),SM=new Yx(Gn,Fs.domElement),to=new Vx,Ya=new qx(16777215,.5);Ya.position.set(-2,2,2);Ya.castShadow=!0;to.add(Ya);const yM=new kx(13565695,11791088,.5);to.add(yM);Gn.position.set(8,0,0);Gn.lookAt(new z(0,0,0));Gn.rotation.z=Math.PI;let ds,ps,TM=new He;const bM=Math.PI/180,AM=()=>{const n=_r.clientWidth,e=_r.clientHeight,t=window.devicePixelRatio;if(ds=n*t,ps=e*t,_r.width!==ds||_r.height!==ps){const i=ds/ps,r=Math.PI/4;Gn.fov=(i>=1?r:2*Math.atan(Math.tan(r/2)/i))/bM,Gn.aspect=i,Gn.updateProjectionMatrix(),Fs.setPixelRatio(t),Fs.setSize(n,e,!1),TM.set(ds/2,ps/2)}};let Ss=new Qs(.05,4,2),pa=new Zs({color:16776960});const th=new an(Ss,pa);th.position.set(1,0,0);const bn=new mr;to.add(bn);bn.add(th);const nh=()=>{const n=Qf.value-Ns.value+1,e=(Ns.value+EM.value/n)%1;{requestAnimationFrame(nh),AM(),SM.update();const t=eh();if(t){const i=bn.children.length;bn.children.forEach((r,s)=>{r.material.color.fromArray(t({index:s,count:i,position:r.position,time:e}))})}Fs.render(to,Gn)}};requestAnimationFrame(nh);const wM=n=>{Ss=new Qs(1,4,2),bn.children=[];const e=[];n.replace(/\r/g,"").split(`
`).forEach(o=>{const l=o.split(" ");if(l[0]==="v"){const c=[l[1]*1,l[2]*1,l[3]*1];e.push(c),pa=new Zs({color:16776960});const u=new an(Ss,pa);u.position.set(c[0],c[1],c[2]),bn.add(u)}});const i=e[0].slice(),r=e[0].slice();e.forEach(o=>{i[0]=Math.min(i[0],o[0]),i[1]=Math.min(i[1],o[1]),i[2]=Math.min(i[2],o[2]),r[0]=Math.max(r[0],o[0]),r[1]=Math.max(r[1],o[1]),r[2]=Math.max(r[2],o[2])});const s=2/Math.max(Math.abs(i[0]),Math.abs(i[1]),Math.abs(i[2]),Math.abs(r[0]),Math.abs(r[1]),Math.abs(r[2])),a=1/s/20;return Ss.scale(a,a,a),bn.scale.set(s,s,s),e},RM=()=>{const n=Qf.value-Ns.value+1,e=eh(),t=[];for(let i=0;i<n;i++){const r=(Ns.value+i/n)%1;if(e){const s=bn.children.length;bn.children.forEach((a,o)=>{t.push(...e({index:o,count:s,position:a.position,time:r}).map(l=>Math.round(l*255)))})}}return t},ih=()=>({processObjText:wM,processOutputColors:RM}),CM=`
...
`;const PM={class:"TimelineControl"},LM=Fe("span",null,"play",-1),UM=Fe("span",{title:"The beginning of all time"},"start",-1),DM=Fe("span",{title:"The end of the world"},"end",-1),IM=Fe("span",{title:"The frame which is currently displayed"},"frame",-1),NM=Fe("span",{title:"Frames Per Second"},"fps",-1),FM={class:"timeline"},OM=["onMousedown","onMousemove"],BM={class:"hover"},zM={__name:"TimelineControl",setup(n){const{isPlaying:e,startFrame:t,endFrame:i,currentFrame:r,framesPerSecond:s}=eo(),a=Oa(()=>i.value-t.value+7),o=Rt(!1),l=f=>{r.value=f},c=f=>{o.value&&l(f)},u=()=>{o.value=!1};return document.body.addEventListener("mouseup",u),Wu(()=>{document.body.removeEventListener("mouseup",u)}),(f,d)=>(ln(),Bn("div",PM,[Fe("form",{onSubmit:d[5]||(d[5]=Ps(()=>{},["prevent"]))},[Fe("div",null,[Fe("label",null,[LM,ii(Fe("input",{type:"checkbox","onUpdate:modelValue":d[0]||(d[0]=m=>tt(e)?e.value=m:null)},null,512),[[Rp,st(e)]])]),Fe("label",null,[UM,ii(Fe("input",{type:"number","onUpdate:modelValue":d[1]||(d[1]=m=>tt(t)?t.value=m:null)},null,512),[[Hi,st(t)]])]),Fe("label",null,[DM,ii(Fe("input",{type:"number","onUpdate:modelValue":d[2]||(d[2]=m=>tt(i)?i.value=m:null)},null,512),[[Hi,st(i)]])]),Fe("label",null,[IM,ii(Fe("input",{type:"number","onUpdate:modelValue":d[3]||(d[3]=m=>tt(r)?r.value=m:null)},null,512),[[Hi,st(r)]])]),Fe("label",null,[NM,ii(Fe("input",{type:"number","onUpdate:modelValue":d[4]||(d[4]=m=>tt(s)?s.value=m:null)},null,512),[[Hi,st(s)]])])])],32),Fe("div",FM,[Fe("div",{class:"bars",onMousedown:d[6]||(d[6]=m=>o.value=!0),onMouseup:d[7]||(d[7]=m=>o.value=!1)},[(ln(!0),Bn(qt,null,qu(a.value,(m,x)=>(ln(),Bn("span",{class:Ur(["bar",{darker:x-2>st(i)||x-2<st(t),active:x-2===st(r)}]),key:x,style:Lr({width:100/a.value+"%"}),onMousedown:v=>l(x-2),onMousemove:v=>c(x-2)},[Fe("span",BM,Ts(x-2),1)],46,OM))),128))],32)])]))}},HM=Fe("span",null,"Vertex Color Function",-1),GM=["onClick"],VM=Fe("input",{type:"submit",value:"Process Color Function"},null,-1),kM={__name:"ColorFunctionControl",setup(n){const{presets:e,colorFunctionString:t,processColorFunction:i}=Jf();return(r,s)=>(ln(),Bn("form",{id:"equations",onSubmit:s[1]||(s[1]=Ps((...a)=>st(i)&&st(i)(...a),["prevent"]))},[Fe("div",null,[Fe("label",null,[HM,ii(Fe("textarea",{"onUpdate:modelValue":s[0]||(s[0]=a=>tt(t)?t.value=a:null),rows:"7",cols:"80"},null,512),[[Hi,st(t)]])])]),Fe("div",null,[(ln(!0),Bn(qt,null,qu(st(e),a=>(ln(),Bn("button",{class:"preset-button",key:a.label,type:"button",onClick:o=>{t.value=a.value,st(i)()}},Ts(a.label),9,GM))),128)),VM])],32))}},{processOutputColors:WM}=ih(),{startFrame:XM,endFrame:qM,framesPerSecond:YM}=eo(),lu=Rt(null),ma=Rt(""),cu=(n,e)=>{let[...t]=n;for(var i=[];t.length;)i.push(t.splice(0,e));return i},jM=n=>{const e=ma.value.replaceAll(" ","_"),t=e.toLocaleUpperCase(),i=n.map(c=>"0x"+c.toString(16).padStart(2,"0").toLocaleUpperCase()),r=qM.value-XM.value+1,s=n.length/3/r,a=r*s-1,o=cu(i,3).map((c,u)=>{let f=",";return u===a&&(f=""),`	${c.join(", ")}${f} // ${u%s}`}),l=cu(o,s).map((c,u)=>`	// frame index ${u}
${c.join(`
`)}`);return`#ifndef ${t}_H
#define ${t}_H
...
static const uint32_t ${e}_frame_rate = ${YM.value};
...
#endif /* ${t}_H */
`},KM=(n,e)=>{let t=n,i="octet/stream";typeof t=="string"&&(t=[t],i="text/plain");const r=new Blob(t,{type:i});return{href:window.URL.createObjectURL(r),target:"_blank",download:e}},$M=()=>({outputName:ma,processedDownloadLink:lu,processOutput:()=>{const n=WM(),e=jM(n);console.log("cHeaderText",e),lu.value=KM(e,ma.value+".h")}});const ZM={id:"controls"},JM=Fe("span",null,"Output object name (probably use snake case or camel case)",-1),QM=Fe("div",null,[Fe("input",{type:"submit",value:"Process Output"})],-1),eE={key:0},tE={class:"bottom-panel"},nE={__name:"App",setup(n){const{processObjText:e}=ih(),{advanceFrame:t,previousFrame:i,isPlaying:r}=eo(),{outputName:s,processedDownloadLink:a,processOutput:o}=$M(),l=Rt([]),c=jf("lastUploadedObjText",Rt(CM)),u=Oa(()=>l.value.length),f=p=>{c.value=p,l.value=e(p)},d=p=>{p.target.files[0].text().then(f)};f(c.value);const m=Rt(!1),x={"`":()=>{m.value=!m.value}," ":()=>{r.value=!r.value},ArrowRight:()=>{r.value=!1,t()},ArrowLeft:()=>{r.value=!1,i()}},v=["INPUT","TEXTAREA","SELECT"];return window.addEventListener("keydown",p=>{console.log(`What is key? "${p.key}"`);const h=x[p.key];h&&!v.includes(p.target.tagName)&&(p.preventDefault(),h())}),(p,h)=>(ln(),Bn("div",ZM,[Fe("div",null,"vertCount: "+Ts(u.value),1),Fe("form",{onSubmit:h[0]||(h[0]=Ps(()=>{},["prevent"]))},[Fe("div",null,[Fe("input",{type:"file",onInput:d},null,32)])],32),Fe("form",{onSubmit:h[2]||(h[2]=Ps((...w)=>st(o)&&st(o)(...w),["prevent"]))},[Fe("div",null,[Fe("label",null,[JM,ii(Fe("input",{type:"text","onUpdate:modelValue":h[1]||(h[1]=w=>tt(s)?s.value=w:null)},null,512),[[Hi,st(s)]])])]),QM],32),st(a)?(ln(),Bn("p",eE,[Fe("a",Mh(sf(st(a))),[of("Download "),Fe("code",null,Ts(st(s))+".h",1)],16)])):Ml("",!0),Fe("div",tE,[m.value?(ln(),nf(kM,{key:0})):Ml("",!0),cn(zM)])]))}};const rh=Ip(nE);rh.use(Bp());rh.mount("#app");
